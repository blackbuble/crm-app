...
<div class="space-y-4 p-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        @if($record->customer->phone)
            ...
            >
                <svg class="w-12 h-12 text-green-600 mb-2" fill="currentColor" viewBox="0 0 24 24">
...
Best regards') }}"
            ...
            >
                <svg class="w-12 h-12 text-yellow-600 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
